...
- BRIDGE-007 tray / pairing PIN UX is IN_PROGRESS on this worktree (`docs/handoffs/BRIDGE-007.md`). Task 2 added the Windows `NotifyIcon` adapter; Task 3 still needs Program registration, STA message loop / WinExe, and AC docs.
...
- **.NET Bridge host:** `dotnet test SimPulse.sln --configuration Release` — succeeded, 0 warnings, 0 errors (2026-08-18, Windows 10.0.26200, SDK 8.0.424). BRIDGE-007 Task 2 host built Release as `net8.0-windows` with `UseWindowsForms`.
...
| --- | --- | --- |
| `dotnet test SimPulse.sln --configuration Release` | Windows 10.0.26200, SDK 8.0.424 | **81 passed**, 0 failed (Domain 6, Analytics 9, Protocol 7, Bridge.Core 59) |
